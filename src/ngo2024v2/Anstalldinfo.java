...
public class Anstalldinfo extends javax.swing.JFrame {
    private InfDB idb;
    private String Anvandarefternamn;

    public Anstalldinfo(String efternamn, InfDB databas) {
        initComponents();
        idb = databas;
        Anvandarefternamn = efternamn;
        Efternamn();
    }

    private void Efternamn() {
        try {
            String sqlFraga = "SELECT * FROM Anstalld WHERE efternamn = '" + Anvandarefternamn + "'";
            HashMap<String, String> dbAnstalld = idb.fetchRow(sqlFraga);

            if (dbAnstalld != null) {
                String ePost = dbAnstalld.get("epost");
                String adress = dbAnstalld.get("adress");
                String telefonnummer = dbAnstalld.get("telefonnummer");
                String Fornamn = dbAnstalld.get("fornamn");
                String Efternamn = dbAnstalld.get("efternamn");
                String Losenord = dbAnstalld.get("losenord");
                String Avdelning = dbAnstalld.get("Avdelning");
